...
export default function AuthPage() {
    const [mode, setMode] = useState<string>('login'); // 'login', 'signup', 'selfie'
    ...
    const handleGoogleSignIn = async () => {
        // Store flag to show selfie capture after Google OAuth
        ...
        <div className={styles.mainWrapper}>
            {signUpSuccess && (
                <div className='fixed bottom-[50px] right-[50px] z-50'>
                    <InfoToast loading={false} success={true} message='Signup successful, login to continue' />
                </div>
            )}
            ...
            {true ? (
                ...
                <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
                    <SelfieCapture
                        userEmail={"visalnaqvi@gmail.com"}
                ...
                <div className={styles.formHolder}>
                    <div className={`${styles.left} bg-blue-600 h-full flex flex-col items-center justify-center rounded-md p-8 gap-y-6`}>
                        ...
                        <p className="m-2 text-center text-white">
                            Need Help? <span className='text-white font-semibold'>Connect with us at +91-8920152023</span>
                        </p>
