...
class UploadQueueManager {
    ...
    private async saveMetadata(item: QueueItem): Promise<void> {
        ...
        const response = await fetch('/api/update-image-upload-status', {
            method: 'POST',
        ...
        <div className="max-w-4xl mx-auto p-6 space-y-6">
            ...
            {/* <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                ...
                <ul className="text-sm text-blue-800 space-y-1">
                    <li>• Uploads continue in the background even if you navigate to other pages</li>
                    <li>• Files are uploaded one at a time for optimal speed and reliability</li>
                    <li>• You can pause/resume uploads at any time</li>
                    <li>• Failed uploads can be retried individually or in batch</li>
                    <li>• Large batches are processed efficiently with progress tracking</li>
                </ul>
            </div> */}
